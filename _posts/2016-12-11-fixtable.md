...
header:
   title:  "HTML 表格冻结"
   image_fullwidth: fixtable-title.jpg
image:
    thumb:  fixtable-thumb.jpg
...
![冻结行(列)表格层叠图]({{site.urlimg}}fixtable-structure-1.jpg)
...
![同时冻结行列表格层叠图]({{site.urlimg}}fixtable-structure-2.jpg)
